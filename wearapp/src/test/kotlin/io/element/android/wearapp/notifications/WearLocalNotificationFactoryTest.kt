...
class WearLocalNotificationFactoryTest {
    ...
    @Test
    fun `thread notification deep links into thread and exposes voice and thread actions`() {
        ...
        assertThat(actions[0].remoteInputs.orEmpty().single().resultKey).isEqualTo(WearNotificationActionReceiver.RESULT_KEY_REPLY_TEXT)
